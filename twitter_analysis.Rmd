---
title: "SatRdays Berlin 2019 Twitter Analysis"
author: "Fabio"
date: "2019-06-15"
output: github_document
---

This is a short notebook outlining the code used to scrape tweets related to the satRdays conference in Berlin.
...
rt <- search_tweets(
  "#tasmconf", n = 5000, include_rts = T, retryonratelimit = T
)
...
rt %>%
  ...
  ggtitle("Number of Tweets by Hour of the Day mentioning #satRdayBerlin") +
...
rt_graph %>% 
  ...
  theme_void() +
  ## title
  ggtitle("#satRdayBerlin Twitter Mentions Network")
...
gg_bigram <- rt %>%
  ...
  filter(word1 != "satRdayBerlin", word2 != "satRdayBerlin") %>%
